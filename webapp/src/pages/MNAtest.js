            ...
            <div className="container">
                <form id="contact_form" action="#" method="POST" encType="multipart/form-data">
                    <div className="row">
                        ...
                        <input type="radio" name="appetite" value="0" />severe decrease in food intake <br />
                    ...
                    <div className="row">
                        ...
                        <input type="radio" name="WL" value="0" />weight loss greater thean 3kg (6.6 lbs) <br />
                    ...
                    <div className="row">
                        ...
                        <input type="radio" name="Mobility" value="0" />bed or chair bound <br />
                    ...
                    <div className="row">
                        ...
                        <input type="radio" name="stress" value="0" />yes <br />
                        ...
                        <input type="radio" name="neuro" value="0" />severe dementia or depression<br />
                ...
                <br />
                        ...
                        <input type="radio" name="BMI" value="0" /> BMI less that 19 <br />
                ...
                <br />
                        ...
                        <input type="radio" name="CC" value="0" />CC less than 31 <br />
